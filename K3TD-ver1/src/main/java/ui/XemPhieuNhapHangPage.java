...
//        tbl_DVT.addMouseListener(this);
    ...
    private void initComponents() {
        ...
        btn_huyPhieuNhap = new javax.swing.JButton();
        ...
        btn_huyPhieuNhap.setText("Hủy phiếu nhập");
        btn_huyPhieuNhap.setBackground(new java.awt.Color(193, 219, 208));
        btn_huyPhieuNhap.setBorderPainted(false);
        btn_huyPhieuNhap.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        btn_huyPhieuNhap.setForeground(new java.awt.Color(218, 80, 90));
        btn_huyPhieuNhap.setPreferredSize(new java.awt.Dimension(150, 45));
        btn_huyPhieuNhap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_huyPhieuNhapActionPerformed(evt);
            }
        });
        jP_bodyHeader.add(btn_huyPhieuNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(1380, 10, 130, 35));
...
//				tbl_HH.getColumnModel().getColumn(5).setCellEditor(new DatePickerEditor());
    ...
    private void btn_huyPhieuNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_huyPhieuNhapActionPerformed
        // TODO add your handling code here:
//    	//tao lo hang
//    	
...
//			}else {
//				showMessage("Số lô hàng đã tồn tại!");
//			}
//    	}
//    	//tao phieu nhap hang
...
//		}
    	...
    	int selectedRow = NhapHangPage.tbl_phieuNhap.getSelectedRow();
    	String ma = NhapHangPage.model_phieuNhap.getValueAt(selectedRow, 1).toString();
    	TrangThaiPhieuNhapHang tt = TrangThaiPhieuNhapHang.DA_HUY;
    	
		if (JOptionPane.showConfirmDialog(this, "Bạn có chắc là muốn hủy phiếu này không?", "Warning!!!",
				JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION) {
			phieuNhapHang_dao.updateTrangThaiPNH(ma, tt);
			showMessage("Hủy thành công!");
		}
    	
    }//GEN-LAST:event_btn_huyPhieuNhapActionPerformed
    ...
    private javax.swing.JButton btn_huyPhieuNhap;
