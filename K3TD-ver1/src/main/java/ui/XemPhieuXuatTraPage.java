...
public class XemPhieuXuatTraPage extends javax.swing.JPanel {
	...
	private ChiTietPhieuXuatTraDao chiTietPXT = new ChiTietPhieuXuatTraDao();
...
//        tbl_DVT.addMouseListener(this);
    ...
    private void initComponents() {
        ...
        btn_taoPhieuNhap1.setText("Hủy phiếu xuất");
...
//    	PhieuXuatTra pnHang = phieuXuatTra_dao.createPXT(pxt, thanhTien);
//    	
//    	if (pnHang != null) {
//    		//tao chi tiet pnh
...
//    			
//    			ChiTietPhieuXuatTra ctPNHang = new ChiTietPhieuXuatTra(pxt, loHH, dvtCT, soLuong, soLuong, chietKhau);
//    			
//    			chiTietPXT .addChiTietPNH(ctPNHang, thanhTienCT);
//    			
//    		}
...
//		}
		...
		int selectedRow = XuatTraPage.tbl_phieuNhap.getSelectedRow();
    	String ma = XuatTraPage.model_phieuNhap.getValueAt(selectedRow, 1).toString();
    	TrangThaiPhieuXuatTra tt = TrangThaiPhieuXuatTra.DA_HUY;
    	
		if (JOptionPane.showConfirmDialog(this, "Bạn có chắc là muốn hủy phiếu này không?", "Warning!!!",
				JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION) {
			phieuXuatTra_dao.updateTrangThaiPXT(ma, tt);
